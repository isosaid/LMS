...
import { API_IMAGE, CourseCardProps } from '../shared/types'
import { Check, FileText } from 'lucide-react'
import { YouTube } from '@mui/icons-material'
import { useFavoriteMaterialsMutation } from '../entities/materials/model/api'
import { useGetUserProfileQuery } from '../entities/User/model/api'


const CourseCardFav: React.FC<CourseCardProps> = ({ course, isFavorite }) => {
	...
	return (
		<Card sx={{ maxWidth: 300, height: '100%', display: 'flex', flexDirection: 'column' }}>
			<CardMedia
  component="img"
  image={`${API_IMAGE}${course.coverImage}`}
  alt={course.title}
